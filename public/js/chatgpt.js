...
document.getElementById("btnEnviar").addEventListener("click", async () => {
  ...
  try {
    ...
    if (!response.ok)
      throw new Error("No se pudo obtener respuesta del servicio de Azure");
    ...
    nuevaOpcion.text =
      textoDelUsuario.length > 30
        ? textoDelUsuario.substring(0, 30) + "..."
        : textoDelUsuario;
    ...
    document.getElementById("textoDelUsuario").value = "";
  } catch (error) {
